...
\section{OBJECTIVE}       Acceptance to PhD Programs in Applied Mathematics.
...
\section{EDUCATION}       Rensselaer Polytechnic Institute, Troy, NY \\
                ...
                Introduction to Quantum Mechanics (III) &  Advanced ODEs and Dynamical Systems \\
                Statistical Mechanics        &  Complex Variables \\
                Electrodynamics              &  Advanced Calculus \\
                Theoretical Mechanics   &  Differential Geometry ($\mathbb{R}^3$) \\
<<<<<<< HEAD
                Experimental Physics &  Number Theory \\ 
                Computational Physics & Linear Algebra \\
                Computing for Physicists & Foundations of Analysis \\
                Quantum Physics II & \\
                Quantum Physics I & \\

=======
                Experimental Physics &  Advanced Calculus \\
                Computing for Physicists & Linear Algebra \\
                Quantum Physics II & Number Theory \\ 
                Quantum Physics I & Foundations of Analysis
>>>>>>> f717c746ba2d6cfb56e598bbc6c95f8f558c04a6
		\end{ncolumn}
