...
\newcommand{\wideline}{\moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}\smallskip \vspace{-0.1cm}}
...
Graduating doctoral student interested in plasma physics, fusion reactor design, and scientific computing.

\vspace{-0.2cm}
\section{EDUCATION}
\vspace{0.2cm}\wideline
\vspace{-0.5cm}
...
\section{SKILLS}
\vspace{0.2cm}\wideline
\textit{Languages and tools:}\\
Python, Julia, Fortran 77/90/95, Matlab, Linux, git, \LaTeX, OpenMP, MPI parallel computing\\
Amazon Web Services, Oracle Cloud, Google Cloud \\
Fortran and C++ graphical / memory debugging tools \\
Linear/nonlinear MHD simulation and analysis with DCON, GPEC, NIMROD

\textit{General/Practical Skills:}\\
